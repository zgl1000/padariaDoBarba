...
<head>
  ...
  <!-- Favicons -->
  <link href="https://www.clipartmax.com/png/full/303-3031180_car-icons-suv-auto-icon.png" rel="icon">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Insira seu e-mail e senha</p>
                  </div>

                  <form action="admin/validaLogin" method="POST" class="row g-3 needs-validation" novalidate>

                    <div class="col-12">
                      <label for="yourUsername" class="form-label">E-mail</label>
                      <div class="input-group has-validation">
                        <input type="text" name="email" class="form-control" id="yourUsername" required>
                        <div class="invalid-feedback">Insira o e-mail.</div>
                      </div>
                    </div>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Ainda não tem uma conta? <a href="/login/registro">Criar uma conta</a></p>
                    </div>
                  </form>
